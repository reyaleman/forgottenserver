...
enum ScreenshotEventType : uint8_t
{
	SCREENSHOTEVENT_ACHIEVEMENT = 1,
	SCREENSHOTEVENT_BESTIARYENTRYCOMPLETED = 2,
	SCREENSHOTEVENT_BESTIARYENTRYUNLOCKED = 3,
	SCREENSHOTEVENT_BOSSDEFEATED = 4,
	SCREENSHOTEVENT_DEATHPVE = 5,
	SCREENSHOTEVENT_DEATHPVP = 6,
	SCREENSHOTEVENT_LEVELUP = 7,
	SCREENSHOTEVENT_PLAYERKILLASSIST = 8,
	SCREENSHOTEVENT_PLAYERKILL = 9,
	SCREENSHOTEVENT_PLAYERATTACKING = 10,
	SCREENSHOTEVENT_TREASUREFOUND = 11,
	SCREENSHOTEVENT_SKILLUP = 12,

	SCREENSHOTEVENT_FIRST = SCREENSHOTEVENT_ACHIEVEMENT,
	SCREENSHOTEVENT_LAST = SCREENSHOTEVENT_SKILLUP
};
